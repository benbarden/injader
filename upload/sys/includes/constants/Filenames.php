...
*/
  ...
  define('FN_ADM_AREA_REORDER',        URL_CP_ROOT.'area_reorder'.F_EXT_PHP);
  ...
  define('FN_ADM_CONNECTION',          URL_CP_ROOT.'connection'.F_EXT_PHP);
  define('FN_ADM_CONNECTIONS',         URL_CP_ROOT.'connections'.F_EXT_PHP);
  define('FN_ADM_CONTACT_ADMIN',       URL_CP_ROOT.'contact_admin'.F_EXT_PHP);
  ...
  define('FN_ADM_EXPORT',              URL_CP_ROOT.'export'.F_EXT_PHP);
  define('FN_ADM_EXTENSION',           URL_CP_ROOT.'extension'.F_EXT_PHP);
  define('FN_ADM_EXTENSIONS',          URL_CP_ROOT.'extensions'.F_EXT_PHP);
  ...
  define('FN_ADM_THEME',               URL_CP_ROOT.'theme'.F_EXT_PHP);
  define('FN_ADM_THEME_PREVIEW',       URL_CP_ROOT.'theme_preview'.F_EXT_PHP);
  define('FN_ADM_THEME_SETTINGS',      URL_CP_ROOT.'theme_settings'.F_EXT_PHP);
  define('FN_ADM_THEMES',              URL_CP_ROOT.'themes'.F_EXT_PHP);
  define('FN_ADM_THEME_FILE',          URL_CP_ROOT.'theme_file'.F_EXT_PHP);
  define('FN_ADM_TOOLS',               URL_CP_ROOT.'tools'.F_EXT_PHP);
  define('FN_ADM_TOOLS_SITEMAP',       URL_CP_ROOT.'tools_sitemap'.F_EXT_PHP);
  define('FN_ADM_TOOLS_SPAM_STATS',    URL_CP_ROOT.'tools_spam_stats'.F_EXT_PHP);
  define('FN_ADM_TOOLS_SQL_QUERY',     URL_CP_ROOT.'tools_sql_query'.F_EXT_PHP);
  ...
  define('FN_ADM_USER_VARIABLE',       URL_CP_ROOT.'user_variable'.F_EXT_PHP);
  define('FN_ADM_USER_VARIABLES',      URL_CP_ROOT.'user_variables'.F_EXT_PHP);
  define('FN_ADM_USERS',               URL_CP_ROOT.'users'.F_EXT_PHP);
  define('FN_ADM_WIDGET',              URL_CP_ROOT.'widget'.F_EXT_PHP);
  define('FN_ADM_WIDGETS',             URL_CP_ROOT.'widgets'.F_EXT_PHP);
  ...
  // Custom
  define('FN_CST_CONTACT', URL_CUSTOM.'contact'.F_EXT_PHP);
?>