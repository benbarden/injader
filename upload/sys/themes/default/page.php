...
?>
<!-- $cmsDownloadAttach -->
<p class="smalltext byline"><span class="author">Posted by <?php print($strContentAuthorName); ?> on <?php print($CMS->TH->GetContentCreateDate()); ?></span><?php print($strContentAuthorLink); ?> | <a href="<?php print($CMS->TH->GetContentLinkURL()); ?>">Permalink</a> | Hits: <?php print($intHits); ?><br />
Tags: 
<?php
...
<?php
  ...
  $strCommentAuthorQuota = $CMS->TH->GetCommentAuthorQuota();
  if ($strCommentAuthorQuota == "1") {
    $strCommentAuthorQuota = $strCommentAuthorQuota." comment";
  } else {
    $strCommentAuthorQuota = $strCommentAuthorQuota." comments";
  }
?>
<div class="comment-author">
<b><?php print($CMS->TH->GetCommentAuthor()); ?></b> | <?php print($CMS->TH->GetCommentCreateDate()); ?> | <?php print($strCommentAuthorHomepageLink); ?> <?php print($strCommentAuthorProfileLink); ?> <?php print($strCommentAuthorQuota); ?> | <a href="<?php print($CMS->TH->GetCommentPermalink()); ?>">Permalink</a></div>
